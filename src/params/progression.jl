...
const HospitalizationTimeSampler = AliasSampler(Int, hospitalization_time_prob)
...
@inline function sample_progression(rng::AbstractRNG, age::Real, gender::Bool,
  ...
  severity = sample_severity(rng, age, gender)
  ...
  if (severity==Severe) || (severity==Critical)
    ...
    recovery_time = severe_symptoms_time + asample(HospitalizationTimeSampler, rng)
  else
