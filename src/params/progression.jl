...
function make_progression_params()
  ...
  dist_severity_by_age = make_dist_severity_by_age(hospitalization_men_probs, hospitalization_women_probs)
...
function sample_severity(rng::AbstractRNG, age::Real, gender::Bool, immunity::ImmunityState, dist_severity_by_age::Vector{Vector{Distributions.Categorical{P, Ps} where {P<:Real, Ps<:AbstractVector{P}}}})
...
function make_dist_severity_by_age(hospitalization_men_probs::Vector{T}, hospitalization_women_probs::Vector{T}) where T<:Real
  ...
  for idx in 1:n
    ...
    dist_severity_by_age[1][idx] = Categorical([0,  1-hospitalization_men_probs[idx],  hospitalization_men_probs[idx]*(1-critical_probs[group_ids]),  hospitalization_men_probs[idx]*critical_probs[group_ids]])
    dist_severity_by_age[2][idx] = Categorical([0,  1-hospitalization_women_probs[idx],  hospitalization_women_probs[idx]*(1-critical_probs[group_ids]),  hospitalization_women_probs[idx]*critical_probs[group_ids]])
  end
  dist_severity_by_age
end